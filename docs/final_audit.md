...
1. Chosen thesis: Contact Topology World Models explores `Predict topology changes in contact graphs rather than only state trajectories.` for contact-rich robot world models.
...
8. Exact Downloads PDF path: `C:/Users/wangz/Downloads/73.pdf`
9. GitHub URL: https://github.com/Jason-Wang313/73_contact_topology_world_models
