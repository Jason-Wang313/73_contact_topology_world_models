...
\usepackage{url}
\usepackage{booktabs}
\title{Contact Topology World Models: ICLR Main-Conference Gate Archive}
\author{Anonymous Authors}
\begin{document}
\maketitle
\begin{abstract}
This document is not an ICLR main-conference submission. It is the v3 main-conference gate for a generated robotics draft about contact-rich robot world models. The original research bet was: Predict topology changes in contact graphs rather than only state trajectories. After a stricter hostile review, the honest terminal decision is \textbf{KILL/ARCHIVE}. Submission-hardening version: v3.
\end{abstract}
...
\begin{itemize}
\item OmniVTA: Visuo-Tactile World Modeling for Contact-Rich Robotic Manipulation (2026)
\item Do World Action Models Generalize Better than VLAs? A Robustness Study (2026)
\item PolyTouch: A Robust Multi-Modal Tactile Sensor for Contact-rich Manipulation Using Tactile-Diffusion Policies (2025)
\item Contact-implicit Model Predictive Control: Controlling diverse quadruped motions without pre-planned contact modes or trajectories (2025)
\item Force Policy: Learning Hybrid Force-Position Control Policy under Interaction Frame for Contact-Rich Manipulation (2026)
\end{itemize}
