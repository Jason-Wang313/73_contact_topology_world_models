...
This repository contains a hardened, honest workshop-only robotics paper draft for `contact_topology_world_models`.
...
Canonical local PDF path: `C:/Users/wangz/Downloads/73.pdf`
